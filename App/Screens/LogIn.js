    ...
    <Modal isVisible={this.state.isModalVisible}>
      <View style={[styles.modal, { justifyContent: 'space-between' }]}>
        <View style={styles.textContainer}>
          <Text style={styles.textModal}>Please check your phone fora verification code.</Text>
        </View>
        <Text style={styles.buttonModal} onPress={this.toggleModal}>Done</Text>
      </View>
    </Modal>
  );
      ...
      <DismissKeyboard>
        <View style={{ flex: 1 }}>
          ...
          <Form
            ...
            keyboardVerticalOffset={Platform.OS === 'ios' ? ifIphoneX(95, 85) : 0}
          >
            <TextInput
