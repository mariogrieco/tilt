...
import {
  ScrollView, Text, TouchableOpacity, Image, Linking, Platform
} from 'react-native';
    ...
    render() {
      return (
        <ScrollView keyboardDismissMode="on-drag" style={{ flex: 1, backgroundColor: '#f6f7f9' }}>
          <TopBlockSpace />
          <TouchableOpacity style={[styles.row, styles.button]} onPress={this.handleEditProfile}>
          ...
          {/*</TouchableOpacity>*/}
          {/*<BlockSpace />*/}
          <TouchableOpacity style={[styles.row, styles.button]} onPress={this.handleInvitePeople}>
            <Image style={styles.icon} source={INVITE_PEOPLE} />
            <Text style={styles.buttonText}>Invite People</Text>
          </TouchableOpacity>
          <Separator />
          <TouchableOpacity style={[styles.row, styles.button]} onPress={this.handleContactSupport}>
            <Image style={styles.icon} source={SUPPORT} />
            <Text style={styles.buttonText}>Contact Support</Text>
          </TouchableOpacity>
          <BlockSpace />
          <TouchableOpacity style={[styles.row, styles.button]} onPress={this.handleLogout}>
