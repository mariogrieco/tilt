...
export const SET_CURRENT_DISPLAY_USER_PROFILE = 'SET_CURRENT_DISPLAY_USER_PROFILE';
...
export const getProfilesInTeam = () => async (dispatch, getState) => {
  try {
    ...
    const payload = await Client4.getProfilesInTeam(team_id, 0, 999999999999999999999999999999999999999);
    dispatch(getUsersSucess(payload));
    return payload;
  } catch (ex) {
    dispatch(getUsersError(ex));
