...
export class PureParsedText extends Component {
  ...
  renderDiscussion(text) {
    return (
      <Text style={themeTags.Discussion}>
        {text.replace(/-/g, ' ')}
      </Text>
    );
  }
