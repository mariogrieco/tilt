...
export default class VideoSample extends PureComponent {
  onPressDownload = async () => {
    ...
    const { link } = await Client4.getFilePublicLink(id).catch(err => console.log(err));
  ...
  render() {
    ...
    return (
      <View style={styles.documentContainer}>
        ...
        <TouchableOpacity style={styles.downloadIconContainer} onPress={this.onPressDownload}>
